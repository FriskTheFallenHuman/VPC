...
bool CVPC::Init( int argc, const char **argv )
{
	...
	Log_Msg( LOG_VPC, "(C) Copyright 1996-2022, Valve Corporation, All rights reserved.\n" );
	Log_Msg( LOG_VPC, "\n" );
...
void CVPC::VPCError( PRINTF_FORMAT_STRING const char* format, ... )
{
	...
	// make ERROR spew in red
	Log_Warning( LOG_VPC, Color( 255, 0, 0, 255 ), "ERROR: " );

	// normal text in white
	Log_Warning( LOG_VPC, Color( 255, 255, 255, 255 ), "%s\n", msg );
...
void CVPC::VPCWarning( PRINTF_FORMAT_STRING const char* format, ... )
{
	...
	// make WARNING spew in yellow
	Log_Warning( LOG_VPC, Color( 255, 255, 0, 255 ), "WARNING: " );
